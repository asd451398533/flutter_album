...
import 'package:flutter_album/util/AlbumUtil.dart';
...
class AlbumPage extends StatefulWidget {
  ...
  AlbumPage(
    ...
    model = new AlbumModel(provider, showCamera, maxCount, selectedList,
        maxVideo, videoSelectPath, noVideoHint, needAiCamera);
  }
                ...
                child: StreamBuilder<String>(
                    ...
                    builder: (context, data) {
                      ...
                      if (data.data == null) {
                        ...
                        text = baseText(showText, 18, Color(0xff323232));
                      }
                      return Row(
                        children: <Widget>[
                          Expanded(
                    ...
                    children: <Widget>[
                      ...
                      _model.isVideo(newIndex)
                          ? Container(
                              ...
                              child: baseText(during, 15, Color(0xffF8F8F8)),
                            )
                          : Container(),
                      GestureDetector(
